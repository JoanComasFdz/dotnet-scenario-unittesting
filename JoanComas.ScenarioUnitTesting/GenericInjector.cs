...
{
    /// <summary>
    /// It customizes the specified <see cref="IFixture"/> to return the specified instance of type <typeparamref name="T"/>.
    /// </summary>
    /// <param name="fixture">The fixture instance to configure.</param>
    /// <param name="instance">The instance to be injected in the fixture.</param>
    // ReSharper disable once UnusedMember.Global Reason: Called via reflection.
